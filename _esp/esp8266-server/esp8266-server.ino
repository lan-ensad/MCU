      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println("<style>html { font-family: Helvetica; display: inline-block; margin: 0px auto; text-align: center; background:#2b2b2b; color:azure;}");
            ...
            client.println("<p>Led_BuiltIn - State " + Led_BuiltInState + "</p>");
...
>>>>>>> b5229416e82b6ada568966fbdd52aef281b483b8
